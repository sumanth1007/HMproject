...
<body>
	<form method="get" action="RoomBooking.jsp">
		<center>
			Enter Room Id : <input type="text" name="roomId"
				value="${param.RoomStatus}" /><br />
			<br /> Enter CustName : <input type="text" name="customerId" /><br />
			<br /> Enter ChkInDate : <input type="date" name="chkinDate" /><br />
			<br /> Enter ChkOutDate : <input type="date" name="chkoutDate" /><br />
			<br /> Enter HotelId : <input type="text" name="hotelId" /><br />
	...
	<c:if test="${param.hotelId != null}">
		...
		<jsp:useBean id="beanBook" class="infinite.HMproject.RoomBooking" />
